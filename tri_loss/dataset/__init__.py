...
from dataset.TrainSet import TrainSet
...
def create_dataset(
  ...
  if name == 'market1501':
    ...
    partition_file = ospeu('/home/mbaharan/shfs/TeCSAR/Datasets/market1501/partitions.pkl')

  elif name == 'cuhk03':
    im_type = ['detected', 'labeled'][0]
    im_dir = ospeu(ospj('/home/mbaharan/shfs/TeCSAR/Datasets/CUHK03', im_type, 'images'))
    partition_file = ospeu(ospj('/home/mbaharan/shfs/TeCSAR/Datasets/CUHK03', im_type, 'partitions.pkl'))

  elif name == 'duke':
    im_dir = ospeu('/home/mbaharan/shfs/TeCSAR/Datasets/DukeMTMC-reID/images')
    partition_file = ospeu('/home/mbaharan/shfs/TeCSAR/Datasets/DukeMTMC-reID/partitions.pkl')

  elif name == 'combined':
    assert part in ['trainval'], \
      "Only trainval part of the combined dataset is available now."
    im_dir = ospeu('/home/mbaharan/shfs/TeCSAR/Datasets/MixDataset_Duke_Market_CUHK03/trainval_images')
    partition_file = ospeu('/home/mbaharan/shfs/TeCSAR/Datasets/MixDataset_Duke_Market_CUHK03/partitions.pkl')
