...
class resNetAvgpooling(nn.Module):
  
   def __init__(self, model):
    super(resNetAvgpooling, self).__init__()
    self.base = model
    self.avg = nn.Sequential(nn.AvgPool2d((16, 8)))
...
def resnet50AvgPooling(pretrained=False, **kwargs):
  """Constructs a ResNet-50 model.
