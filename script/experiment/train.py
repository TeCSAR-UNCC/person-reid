...
class Config(object):
  def __init__(self):
    ...
    # Pre-trained shuffleNet path
    self.net_pretrained_path = args.net_pretrained_path
    self.net = args.net
    ...
    # Half precision learning and inferencing
    self.opt_level=args.opt_level
    self.keep_batchnorm_fp32=args.keep_batchnorm_fp32
